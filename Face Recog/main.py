...
class App:
    def __init__(self):
        ...
        self.db_dir='C:/Users/chand/OneDrive/Desktop/Face Recog/Attendance'
        if not os.path.exists(self.db_dir):
            os.mkdir(self.db_dir)
        self.log_path= 'C:/Users/chand/OneDrive/Desktop/Face Recog/log.txt'

    def add_webcam(self, label):
        if 'cap' not in self.__dict__:
             self.cap=cv2.VideoCapture(0) # 2 for external webcam
        self.label_=label
        self.process_webcam()
